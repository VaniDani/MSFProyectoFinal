...
# Información general
Se estudió el sistema ocular, enfocándose en el flujo del humor acuoso y la presión intraocular. Para analizar su dinámica se utilizó un modelo eléctrico mediante un circuito RLC de dos mallas, donde cada parámetro representa una característica fisiológica del ojo.
...
# Objetivos
Modelar el sistema ocular mediante una analogía eléctrica con un circuito RLC de dos mallas, representando el flujo del humor acuoso y la presión intraocular.
